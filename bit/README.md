...
- 휴대폰 인증을 통한 SBS 가요대전 방청권 티케팅 시스템을 개발하여 **1.8만 RPS** 에 대응
...
- 6백만 고객과 천5십만 회원계정의 정합성 체크 배치를 설계 후 개발 중입니다.
- 정합성에 문제가 있을 시 Slack 알림을 보내도록 하였습니다.
- 정합성 체크 전략을 연쇄 체인 구조로 설계하여, 정합성 로직의 확장성에 대비했습니다.
- JDBC 의 READ_ONLY 옵션을 활용하여 row 혹은 table 단위의 락을 방지하였습니다.
- JDBC 의 TYPE_FOWARD_ONLY 옵션을 활용하여 트랜잭션 영향이 없도록 했습니다.
