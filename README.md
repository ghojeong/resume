...
개발과 관련된 회사, 대학교, 커뮤니티 이력을 정리한 문서입니다.<br>
...
- 기억에 남는 점
  ...
  - 하드웨어를 제조하는 파트너사가 델파이 2007을 지원해 달라고 요청했습니다.
  - 델파이 2007로 인한 기술적 역경 극복
    - 델파이 2007은 UTF-8 이 안됩니다.
    - 델파이 2007은 HTTP Request를 할 때 Body 없이 URL을 통해서만 데이터를 보낼 수 있습니다.
