...
- 설명
  ...
  - 고정완이 2개의 세션을 발표했습니다.
    - 첫번째 세션: 개발자가 되고 싶은 대학생 및 성인을 대상으로 회사에서 주니어로써 겪었던 어려움들을 에피소드드로 풀었습니다.
    - 두번째 세션: 개발자로 취업을 희망하는 친구들과 3개월 동안 만든 미니 프로젝트를 발표했습니다.
- 기억에 남는 점
  - 1만 1천원을 내고, 80명이 넘는 사람들이 강의장을 꽉 채웠습니다.
  - 준비를 할 때도 긴장했지만, 발표를 할 때는 더욱 긴장해서 다리에 힘이 들어가지 않아 중간에 의자에 앉아야 했습니다.
...
- 기억에 남는 점
  ...
  - 아직 주니어 개발자인 스스로가 본받고 싶은 분들을 많이 만나 행복했습니다.
...
- 기억에 남는 점
  - 훈련소에 가야하는 11월이 다가오자, 심각한 무기력증에 빠져서 스터디를 계속 진행하지 못하고 흐지부지 되었습니다.
  - 스터디의 주최자로써, 스터디에 모여주신 분들에게 더 좋은 경험을 제공하지 못해서 지금도 미안함이 남아있습니다.
