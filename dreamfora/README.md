...
- 200만 다운로드, MAU 16만, 미국 앱스토어 피처드된 B2C 목표관리 앱
...
- 주요성과
  ...
  - 세션 기반에서 토큰 기반 인증으로 전환 후 인증시간을 [8초에서 0.1초로 단축](#세션-기반-인증을-jwt-기반-인증으로-리팩토링)
...
- 설명
  ...
  - 인증시간이 **8초 내외에서 0.1초** 이내로 단축되었습니다.
