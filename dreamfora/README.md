...
- 운영 및 리팩토링
  ...
  - 주요성과
    ...
    - [테스트 커버리지 83% 달성](#atdd-와-rest-docs-를-통한-문서화)
...
- 설명
  ...
  - **테스트 커버리지가 83%** 였기에, 테스트를 모두 통과하면 실서비스 장애도 없을거라는 자신이 있었습니다.
...
- 설명
  ...
  - 최종적으로는 서버비용이 월평균 **1518달러에서 270달러** 로 줄었습니다.
...
- 설명
  ...
  - ATDD Cycle 을 통해 **테스트 커버리지 83%** 를 달성했습니다.
